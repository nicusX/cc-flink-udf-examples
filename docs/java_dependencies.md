...
When you build your own Java UDF project, there are some important aspect to consider.
...
If your UDF use any library also included as transitive dependency from the Flink libraries, you should use the version
provided by Flink rather than including your own dependency to the POM.
...
You can see the transitive provided dependency from the Maven dependency tree:
